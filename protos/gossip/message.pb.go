...
type GossipMessage_AdvMsg struct {
	AdvMsg *AdvertiseMessage `protobuf:"bytes,8,opt,name=adv_msg,json=advMsg,oneof"`
}
type GossipMessage_ReqMsg struct {
	ReqMsg *RequestMessage `protobuf:"bytes,9,opt,name=req_msg,json=reqMsg,oneof"`
}
type GossipMessage_DataMsg struct {
	DataMsg *DataMessage `protobuf:"bytes,10,opt,name=data_msg,json=dataMsg,oneof"`
}
type GossipMessage_Hello struct {
	Hello *GossipHello `protobuf:"bytes,11,opt,name=hello,oneof"`
}
type GossipMessage_DataDig struct {
	DataDig *DataDigest `protobuf:"bytes,12,opt,name=data_dig,json=dataDig,oneof"`
}
type GossipMessage_DataReq struct {
	DataReq *DataRequest `protobuf:"bytes,13,opt,name=data_req,json=dataReq,oneof"`
}
type GossipMessage_DataUpdate struct {
	DataUpdate *DataUpdate `protobuf:"bytes,14,opt,name=data_update,json=dataUpdate,oneof"`
}
type GossipMessage_Empty struct {
	Empty *Empty `protobuf:"bytes,15,opt,name=empty,oneof"`
}
type GossipMessage_Conn struct {
	Conn *ConnEstablish `protobuf:"bytes,16,opt,name=conn,oneof"`
}
type GossipMessage_StateInfo struct {
	StateInfo *StateInfo `protobuf:"bytes,17,opt,name=state_info,json=stateInfo,oneof"`
}
type GossipMessage_StateSnapshot struct {
	StateSnapshot *StateInfoSnapshot `protobuf:"bytes,18,opt,name=state_snapshot,json=stateSnapshot,oneof"`
}
type GossipMessage_StateInfoPullReq struct {
	StateInfoPullReq *StateInfoPullRequest `protobuf:"bytes,19,opt,name=state_info_pull_req,json=stateInfoPullReq,oneof"`
}
type GossipMessage_StateRequest struct {
	StateRequest *RemoteStateRequest `protobuf:"bytes,20,opt,name=state_request,json=stateRequest,oneof"`
}
type GossipMessage_StateResponse struct {
	StateResponse *RemoteStateResponse `protobuf:"bytes,21,opt,name=state_response,json=stateResponse,oneof"`
}
type GossipMessage_LeadershipMsg struct {
	LeadershipMsg *LeadershipMessage `protobuf:"bytes,22,opt,name=leadership_msg,json=leadershipMsg,oneof"`
}
type GossipMessage_PeerIdentity struct {
	PeerIdentity *PeerIdentity `protobuf:"bytes,23,opt,name=peer_identity,json=peerIdentity,oneof"`
}
type GossipMessage_Ack struct {
	Ack *Acknowledgement `protobuf:"bytes,24,opt,name=ack,oneof"`
}
type GossipMessage_PrivateReq struct {
	PrivateReq *RemotePvtDataRequest `protobuf:"bytes,25,opt,name=privateReq,oneof"`
}
type GossipMessage_PrivateRes struct {
	PrivateRes *RemotePvtDataResponse `protobuf:"bytes,26,opt,name=privateRes,oneof"`
}
type GossipMessage_PrivateData struct {
	PrivateData *PrivateDataMessage `protobuf:"bytes,27,opt,name=private_data,json=privateData,oneof"`
}
...
func (*GossipMessage_AdvMsg) isGossipMessage_Content()           {}
...
func (m *GossipMessage) GetAdvMsg() *AdvertiseMessage {
	if x, ok := m.GetContent().(*GossipMessage_AdvMsg); ok {
		return x.AdvMsg
	}
	return nil
}
...
func _GossipMessage_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *GossipMessage_AdvMsg:
		b.EncodeVarint(8<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.AdvMsg); err != nil {
			return err
		}
...
func _GossipMessage_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 7: // content.mem_res
		...
		return true, err
	case 8: // content.adv_msg
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(AdvertiseMessage)
		err := b.DecodeMessage(msg)
		m.Content = &GossipMessage_AdvMsg{msg}
		return true, err
	case 9: // content.req_msg
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
	...
	case 17: // content.state_info
		...
		return true, err
	case 18: // content.state_snapshot
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		...
		return true, err
	case 19: // content.state_info_pull_req
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
	...
	case 20: // content.state_request
		...
		return true, err
	case 21: // content.state_response
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		...
		return true, err
	case 22: // content.leadership_msg
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
...
func (*AdvertiseMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }

func (m *AdvertiseMessage) GetNonce() uint64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
func (m *AdvertiseMessage) GetSeqNum() uint64 {
	if m != nil {
		return m.SeqNum
	}
	return 0
...
func (*RequestMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{15} }

func (m *RequestMessage) GetNonce() uint64 {
	if m != nil {
		return m.Nonce
	}
	return 0
...
type DataMessage struct {
	PushTTL int32    `protobuf:"varint,1,opt,name=PushTTL" json:"PushTTL,omitempty"`
	AdvTTL  int32    `protobuf:"varint,2,opt,name=AdvTTL" json:"AdvTTL,omitempty"`
	PullTTL int32    `protobuf:"varint,3,opt,name=PullTTL" json:"PullTTL,omitempty"`
	Payload *Payload `protobuf:"bytes,4,opt,name=payload" json:"payload,omitempty"`
}

func (m *DataMessage) Reset()                    { *m = DataMessage{} }
func (m *DataMessage) String() string            { return proto.CompactTextString(m) }
func (*DataMessage) ProtoMessage()               {}
func (*DataMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }
...
func (m *DataMessage) GetPullTTL() int32 {
	if m != nil {
		return m.PullTTL
	}
	return 0
...
func (*PrivateDataMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{17} }
...
func (*Payload) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (*Chaincode) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{35} }
...
func init() {
	...
	proto.RegisterType((*AdvertiseMessage)(nil), "gossip.AdvertiseMessage")
...
var fileDescriptor0 = []byte{
	...
	,
}
